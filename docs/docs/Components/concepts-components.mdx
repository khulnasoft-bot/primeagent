...
For example, the [**Recursive Character Text Splitter** component](https://github.com/khulnasoft/primeagent/blob/main/src/backend/base/primeagent/components/langchain_utilities/recursive_character.py) is a child of the [`LCTextSplitterComponent`](https://github.com/khulnasoft/primeagent/blob/main/src/backend/base/primeagent/base/textsplitters/model.py) class.
