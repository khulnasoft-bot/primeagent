...
Several file formats are supported, and you can store files in [Primeagent storage](/memory) or the local file system.
...
In Primeagent version 1.5, this component was renamed from **Lambda Filter** to **Smart Function**.
