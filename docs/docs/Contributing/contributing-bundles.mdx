...
1. Navigate to the backend directory in the Primeagent repository and create a new folder for your bundle.
The path for your new component is `src > backend > base > primeagent > components > darth_vader`.
You can view the [components folder](https://github.com/khulnasoft/primeagent/tree/main/src/backend/base/primeagent/components) in the Primeagent repository.
...
For an example of adding multiple components in a bundle, see the [Notion](https://github.com/khulnasoft/primeagent/tree/main/src/backend/base/primeagent/components/Notion) bundle.
...
You can view the [icons folder](https://github.com/khulnasoft/primeagent/tree/main/src/frontend/src/icons) in the Primeagent repository.
...
You can view the [lazyIconImports.ts](https://github.com/khulnasoft/primeagent/blob/main/src/frontend/src/icons/lazyIconImports.ts) in the Primeagent repository.
...
8. To add your bundle to the <Icon name="Blocks" aria-hidden="true" /> **Bundles** menu, edit the [`SIDEBAR_BUNDLES` array](https://github.com/khulnasoft/primeagent/blob/main/src/frontend/src/utils/styleUtils.ts#L231) in `/src/frontend/src/utils/styleUtils.ts`.

    Add an object to the array with the following keys:

    * `display_name`: The text label shown in the Primeagent visual editor
    * `name`: The name of the folder you created within the `/src/backend/base/primeagent/components` directory
