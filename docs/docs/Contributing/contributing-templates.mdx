...
For template formatting examples, see [`/starter_projects`](https://github.com/khulnasoft/primeagent/tree/main/src/backend/base/primeagent/initial_setup/starter_projects) in the Primeagent repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Primeagent repository](https://github.com/khulnasoft/primeagent) on GitHub.
...
For more information, see the Primeagent repository's [template categories](https://github.com/khulnasoft/primeagent/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).