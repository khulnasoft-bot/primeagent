...
New components are added as objects of the [`Component`](https://github.com/khulnasoft/primeagent/blob/main/src/backend/base/primeagent/custom/custom_component/component.py) class.

Dependencies are added to the [pyproject.toml](https://github.com/khulnasoft/primeagent/blob/main/pyproject.toml#L148) file.
...
2. Write your processor as an object of the [`Component`](https://github.com/khulnasoft/primeagent/blob/main/src/backend/base/primeagent/custom/custom_component/component.py) class. You'll create a new class, `DataFrameProcessor`, that will inherit from `Component` and override the base class's methods.
...
class DataFrameProcessor(Component):
    ...
    documentation: str = "https://primeagent-docs.khulnasoft.com/components-dataframe-processor"
...
5. Save the `dataframe_processor.py` to the `src > backend > base > primeagent > components` directory.
This example adds a data component, so add it to the `/data` directory.

6. Add the component dependency to `src > backend > base > primeagent > components > data > __init__.py` as `from .DataFrameProcessor import DataFrameProcessor`.
You can view the [/data/__init__.py](https://github.com/khulnasoft/primeagent/blob/dev/src/backend/base/primeagent/components/data/__init__.py) in the Primeagent repository.

7. Add any new dependencies to the [pyproject.toml](https://github.com/khulnasoft/primeagent/blob/main/pyproject.toml#L20) file.

8. Submit documentation for your component. For this example component, you would submit documentation to the [Data components page](https://github.com/khulnasoft/primeagent/blob/main/docs/docs/Components/components-data.mdx).
