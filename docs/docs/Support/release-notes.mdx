...
For all changes, see the [Changelog](https://github.com/khulnasoft/primeagent/releases/latest).
...
For all changes, see the [Changelog](https://github.com/khulnasoft/primeagent/releases).
...
Instead, download a fresh installation from the [Primeagent website](https://primeagent.khulnasoft.com) when a new version is available.
...
5. Download the Windows installer from the [Primeagent website](https://primeagent.khulnasoft.com).
...
- Advanced document parsing with built-in Docling support
  ...
  To make it easier to use the [**Docling** components](/bundles-docling) and the **File** component's new advanced parsing feature, the Docling dependency is now included with Primeagent for all operating systems except macOS Intel (x86_64).
...
- Stability improvements
    ...
    See an issue? [Raise it on GitHub](https://github.com/khulnasoft/primeagent/issues).
...
See the [Changelog](https://github.com/khulnasoft/primeagent/releases).