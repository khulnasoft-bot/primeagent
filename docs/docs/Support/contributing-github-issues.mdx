...
The [Issues page in the Primeagent repository](https://github.com/khulnasoft/primeagent/issues) is actively updated with bugs and feature requests.
...
Use the [Primeagent repository's labels](https://github.com/khulnasoft/primeagent/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Primeagent in general, you can visit the [Primeagent GitHub Discussions page](https://github.com/khulnasoft/primeagent/discussions) or reach out through other [Primeagent community](/contributing-community) channels.
