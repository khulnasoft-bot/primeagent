...
:::tip
For help with constructing file upload requests in Python, JavaScript, and curl, see the [Primeagent File Upload Utility](https://primeagent-file-upload-examples.onrender.com).
:::
...
1. To construct the request, gather the following information:
    ...
    * `FILE_COMPONENT_ID`: The UUID of the **File** component in your flow, such as `File-KZP68`. To find the component ID, open your flow in Primeagent, click the **File** component, and then click **Controls**. The component ID is at the top of the **Controls** pane.
...
In the visual editor, you can preload files to the **File** component by selecting them from your local machine or [Primeagent file management](/concepts-file-management).
